...
// print(decodedResponse);
  ...
  static Future<bool> deleteDoctor(String doctorId)async{
    ...
    try{
      response = await http.delete(
        Uri.parse('${Config.apiUrl}${Config.deleteDoctorUrl}?id=$doctorId'),
        headers: requestHeaders,
      )
      ;
    }catch(e)
    {
      print('Doctor Delete api call error: $e');
    }
  ...
  // DELETE Pharmacist
  static Future<bool> deletePharmacist(String pharmacistId)async{
    final SharedPreferences pref = await SharedPreferences.getInstance();
    String? token = pref.getString("token");
    ...
    try{
      response = await http.delete(
        Uri.parse('${Config.apiUrl}${Config.deletePharmacistUrl}?id=$pharmacistId'),
        headers: requestHeaders,
      )
      ;
    }catch(e)
    {
      print('Pharmacist Delete api call error: $e');
    }
