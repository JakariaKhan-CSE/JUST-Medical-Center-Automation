...
class FirstTimeUpdateProfilePage extends StatefulWidget {
  ...
  @override
  State<FirstTimeUpdateProfilePage> createState() => _FirstTimeUpdateProfilePageState();
}

class _FirstTimeUpdateProfilePageState extends State<FirstTimeUpdateProfilePage> {
...
body: Center(
  child: SingleChildScrollView(
    child: Column(
      ...
      children: [
        SizedBox(height: 20,),
        Text('Update Doctor Profile',style: Responsive.isDesktop(context) ? Theme.of(context).textTheme.displayLarge!.copyWith(fontWeight: FontWeight.w800,letterSpacing: 2.3):
        Theme.of(context).textTheme.headlineMedium!.copyWith(fontWeight: FontWeight.w700,letterSpacing: 2.0),),
        SizedBox(height: 10,),
        Padding(
        ...
        GestureDetector(
          onTap: () async {
            ...
            if (imageUploader.profileImageUrl == null) {
              ...
              await imageUploader.deleteProfileImageFromCloudinary(imageUploader.profilePublicID!);
            }
          },
          child: CircleAvatar(
            radius: 40,
            ...
            backgroundImage: imageUploader.profileImageUrl != null
                ? NetworkImage(
                imageUploader.profileImageUrl??'https://cdn-icons-png.flaticon.com/512/3135/3135715.png') // Show uploaded image
                : null,
                ...
                GestureDetector(
                  onTap: () async {
                    ...
                    if (imageUploader.SignatureImageUrl == null) {
                      ...
                      // Delete image if it already exists
                      await imageUploader.deleteSignatureImageFromCloudinary(imageUploader.signaturePublicID!);
                    }
                  },
                  child: Container(
                    height: 60,
                ...
                Align(
                  ...
                  child: CustomButton(pressed: (){
                   if(_key.currentState!.validate())
                    ...
                    backgroundColor: Colors.lightGreen.withValues(alpha: 0.7),
                  ),
                ),
                SizedBox(height: 30,),
              ],
